...
class WPEditor {
  ...
  public function registerDefaultScript() {
    ...
    wp_register_script('codemirror', WPEDITOR_URL . '/extensions/codemirror/js/codemirror.js', array( 'jquery' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_php', WPEDITOR_URL . '/extensions/codemirror/js/php.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_javascript', WPEDITOR_URL . '/extensions/codemirror/js/javascript.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_css', WPEDITOR_URL . '/extensions/codemirror/js/css.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_xml', WPEDITOR_URL . '/extensions/codemirror/js/xml.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_clike', WPEDITOR_URL . '/extensions/codemirror/js/clike.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_dialog', WPEDITOR_URL . '/extensions/codemirror/js/dialog.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_search', WPEDITOR_URL . '/extensions/codemirror/js/search.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_searchcursor', WPEDITOR_URL . '/extensions/codemirror/js/searchcursor.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
    wp_register_script('codemirror_mustache', WPEDITOR_URL . '/extensions/codemirror/js/mustache.js', array( 'jquery', 'codemirror' ), WPEDITOR_VERSION_NUMBER);
