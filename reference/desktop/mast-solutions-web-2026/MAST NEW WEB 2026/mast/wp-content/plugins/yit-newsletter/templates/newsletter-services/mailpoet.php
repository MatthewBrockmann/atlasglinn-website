        ...
        <ul class="group">
            <li>
                ...
                <div class="newsletter_form_email">
                    <input type="text" <?php echo ( $shortcode == 'newsletter_cta' ) ? 'placeholder="' . __( 'Email', 'yit' ) . '"' : ''?> name="yit_mailpoet_newsletter_form_email" id="yit_mailpoet_newsletter_form_email" class="email-field text-field autoclear" />
            ...
            <li>
                ...
                <input class="button btn btn-alternative submit-field mailpoet-subscription-ajax-submit" type="button" value="<?php _e( 'Submit', 'yit' ) ?>" />
            </li>
        </ul>
    </fieldset>
</form>
