...
class YIT_CPT_Unlimited {
    ...
    public function add_metabox_cptu() {
        ...
        if ( ! $this->_args['manage_layouts'] || count( $layouts ) < 2 ) {
    ...
    */
    ...
    /**
     * Add the inline style in the page to something in the table lists
     *
     * @return void
     * @since  1.0
     * @author Antonino Scarfi' <antonino.scarfi@yithemes.com>
    ...
    public function admin_inline_style() {
        ?>
        <style type="text/css">
            table.wp-list-table .column-thumbnail { width: 80px; }
        </style>
        <?php
    }
...
//        }
        ...
        extract( apply_filters( 'yit_cptu_frontend_vars', array( 'name' => str_replace( $this->_prefix_cpt, '', $post->post_type ) ), $this->_name ) );
