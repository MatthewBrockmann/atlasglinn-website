...
class YIT_Testimonial {
    ...
    public function enqueue_scripts() {
        ...
        yit_enqueue_script( 'yit-testimonial', $this->plugin_assets_url . '/js/yit-testimonial-frontend.min.js', $this->version );
    }
    ...
    public function admin_enqueue_scripts() {
        //wp_enqueue_script( 'yit-faq-admin', $this->plugin_assets_url . '/js/yit-faq-admin.js', array( 'jquery' ), $this->version, true );
