...
<div class="wrap">
  ...
  <script type="text/javascript">
    ...
    function runCodeMirror(extension) {
      ...
      $jq('#plugin_save').die("click.wp-editor").live("click.wp-editor", function() {
        $jq('.ajax-editor-update').submit();
        editor.focus();
      })
      $jq('#plugin_undo').die("click.wp-editor").live("click.wp-editor", function() {
        editor.undo();
        editor.focus();
      })
      $jq('#plugin_redo').die("click.wp-editor").live("click.wp-editor", function() {
        editor.redo();
        editor.focus();
      })
      $jq('#plugin_search').die("click.wp-editor").live("click.wp-editor", function() {
        CodeMirror.commands.find(editor);
        return false;
      })
      $jq('#plugin_find_next').die("click.wp-editor").live("click.wp-editor", function() {
        CodeMirror.commands.findNext(editor);
        return false;
      })
      $jq('#plugin_find_prev').die("click.wp-editor").live("click.wp-editor", function() {
        CodeMirror.commands.findPrev(editor);
        return false;
      })
      $jq('#plugin_replace').die("click.wp-editor").live("click.wp-editor", function() {
        CodeMirror.commands.replace(editor);
        return false;
      })
      $jq('#plugin_replace_all').die("click.wp-editor").live("click.wp-editor", function() {
